...
%
% ... some edits made by Eric S-Brown
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% define matrices of connections; random positive values
...
% desired.  This makes them mean 1
for i = 1:NE
...
%% Do some analysis of the resulting connectivity matrix
W = [ WEE -WEI ; WIE -WII];
eigs_of_W = eig(W);
...
tauI = tauE;                   % time constnat for I-units
